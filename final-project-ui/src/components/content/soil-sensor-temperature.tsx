...
@customElement('oj-soil-temperature-chart-component')
export class SoilTemperatureChartComponent extends Component<ExtendGlobalProps<Props>, State>{
                ...
                graphDataArray.forEach(d=>
                    {
                       // console.log(d);
                        humidityData.push({
                            id: d.READING_ID,
                            series: "Soil Sensor Temperature",
                            time: d.DATE_TIMESTAMP,
                            isPumpOn: d.IS_PUMP_ON,
                            value:d.SOIL_SENSOR_TEMP,
                        });
                    }
                )
